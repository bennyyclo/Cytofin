...
#'
#' @param sample_metadata_filename, panel_filename, input_file_dir, val_file_dir,output_file_dir, nchannels
#' @return normalized files with specified panel
#' @export

annorm_nrs <- function(sample_metadata_filename, panel_filename, input_file_dir, val_file_dir="none", output_file_dir, nchannels){
